...
func NewPullClient(cfg PullConfigResult, ua, origin string, logFn func(string, ...any)) *PullClient {
	return &PullClient{cfg: cfg, ua: ua, origin: origin, logFn: logFn}
}
